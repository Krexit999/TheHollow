...
const AUDIT: Entry[] = [
  ...
  { system: 'Ember Array', kind: 'shaping', frequency: 'occasional',
    verb: 'place fuels on a grid and light cells so neighbours sustain each other',
    actions: ['buyFuel', 'placeFuel', 'lightCell', 'setOverdrive', 'setDraw'] },
  { system: 'Greenhouse / Mycelium', kind: 'shaping', frequency: 'occasional',
    verb: 'plant, cross-breed strains, inoculate and feed a spreading network',
    actions: ['plantSeed', 'harvestPlot', 'inoculate', 'feedMycelium'] },
  { system: 'The Loom', kind: 'shaping', frequency: 'occasional',
    verb: 'set threads and commit a weave; shapes emerge from the arrangement',
    actions: ['setThread', 'commitWeave', 'spinThread'] },
  { system: 'Brewing / the Still', kind: 'choosing', frequency: 'occasional',
    verb: 'experiment toward a recipe, drink for a timed spike',
    actions: ['brewExperiment', 'drinkBrew'] },
  { system: 'The Warrens', kind: 'choosing', frequency: 'occasional',
    verb: 'enter, investigate, answer, then choose restore / extract / preserve',
    actions: ['warrenEnter', 'warrenAnswer', 'warrenClaim', 'warrenLeave'],
    note: 'SYSTEM_IMPROVEMENTS wants the quiz replaced with a puzzle or a fight; the surrounding structure is already a real choice.' },
  { system: 'Observatory / Bench', kind: 'choosing', frequency: 'occasional',
    verb: 'start an exposure, grind and equip lenses, attempt a solve',
    actions: ['startObservation', 'collectObservation', 'benchAttempt', 'grindChartLens', 'equipLens'] },
  ...
  { system: 'Echo Chamber', kind: 'shaping', frequency: 'rare',
    verb: 'record a sequence of real actions onto a tape and loop it',
    actions: ['tapeRecord', 'tapeRun', 'tapeClear'] },
  { system: 'Magma Wells', kind: 'number', frequency: 'occasional',
    verb: 'commit an amount, collect the result',
    actions: ['commitWell', 'collectWell'],
    note: 'An opt-in gamble by design. SYSTEM_IMPROVEMENTS proposes a "read the well" tell so attention pays a little.' },
  { system: 'Relics', kind: 'number', frequency: 'occasional',
    verb: 'equip into slots, fuse duplicates, lock, donate',
    actions: ['equipRelic', 'unequipRelic', 'fuseRelics', 'toggleRelicLock', 'donateRelic'],
    note: 'Flagged: slot-and-stat. SYSTEM_IMPROVEMENTS wants relic HISTORY, awakening, and set resonance — the biggest "big game" layer in the doc and near-zero mechanical cost.' },
  { system: 'The Museum', kind: 'number', frequency: 'occasional',
    verb: 'donate items into cases',
    actions: ['donateItem'],
    note: 'Flagged: a donate button. The doc wants ARRANGING exhibits, with hidden named sets discovered by placement (pillar 5).' },
